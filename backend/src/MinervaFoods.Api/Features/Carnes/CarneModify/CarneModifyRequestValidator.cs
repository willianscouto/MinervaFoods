...
{
    /// <summary>
    /// Validator for CarneModifyRequest that defines validation rules for user creation.
    /// </summary>
    public class CarneModifyRequestValidator : AbstractValidator<CarneModifyRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CarneModifyRequestValidator"/> class 
        /// with defined validation rules for project creation.
        /// </summary>
        public CarneModifyRequestValidator()
        {
            RuleFor(c => c.Id)
