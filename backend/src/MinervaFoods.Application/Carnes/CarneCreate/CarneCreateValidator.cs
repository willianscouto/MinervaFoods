...
{
    /// <summary>
    /// Validator for <see cref="CommentCreateCommand"/> that defines validation rules for comment creation.
    /// </summary>
    /// <remarks>
    ...
    /// </list>
    /// </remarks>
    public class CarneCreateValidator : AbstractValidator<CarneCreateCommand>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommentCreateValidator"/> class 
        /// with defined validation rules for comment creation.
        /// </summary>
        public CarneCreateValidator()
        {
            RuleFor(c => c.Ean)
