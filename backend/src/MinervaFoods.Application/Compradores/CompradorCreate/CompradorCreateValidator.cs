...
{
    /// <summary>
    /// Validador para o comando <see cref="CompradorCreateCommand"/> que define regras para criação de um comprador.
    /// </summary>
    /// <remarks>
    ...
    /// </list>
    /// </remarks>
    public class CompradorCreateValidator : AbstractValidator<CompradorCreateCommand>
    {
        /// <summary>
        /// Inicializa uma nova instância da classe <see cref="CompradorCreateValidator"/>
        /// com regras de validação definidas para criação de comprador.
        /// </summary>
        public CompradorCreateValidator()
        {
            RuleFor(c => c.Nome)
