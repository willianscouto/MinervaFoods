...
namespace MinervaFoods.Application.Compradores.CompradorModify
{
    ...
    /// </list>
    /// </remarks>
    public class CompradorModifyValidator : AbstractValidator<CompradorModifyCommand>
    {
        /// <summary>
        /// Inicializa uma nova instância de <see cref="CompradorModifyValidator"/>, definindo as regras de validação.
        /// </summary>
        public CompradorModifyValidator()
        {
            RuleFor(c => c.Id)
                .NotEqual(Guid.Empty)
